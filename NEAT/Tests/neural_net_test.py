...
def given_a_genome():
    ...
    nodes = {node1.get_id(): node1, node2.get_id(): node2, node3.get_id(): node3, node4.get_id(): node4,
             node5.get_id(): node5}
    conn1 = ConnectionGene(node1.get_id(), node4.get_id(), 0.5, innovation_number=1)
    ...
    conn4 = ConnectionGene(node2.get_id(), node5.get_id(), 0.5, innovation_number=4)
    conn5 = ConnectionGene(node5.get_id(), node4.get_id(), 0.5, innovation_number=5)
    conn6 = ConnectionGene(node1.get_id(), node5.get_id(), 0.5, innovation_number=6)
    conn7 = ConnectionGene(node4.get_id(), node5.get_id(), 0.5, False, innovation_number=11)
